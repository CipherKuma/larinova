...
export default function BillingClient() {
  ...
  const isPro = plan === "pro" && data?.subscription?.status === "active";
    ...
    <>
      ...
      <div className="glass-card relative">
        ...
        <div className="absolute inset-0 z-10 flex items-center justify-center rounded-2xl">
          ...
          <span className="relative z-20 text-3xl md:text-5xl font-bold uppercase tracking-widest text-foreground/80">
            Coming Soon
          </span>
        </div>
        {/* Header + Current Plan */}
        ...
        <div className="p-6">
          <div className="grid md:grid-cols-3 gap-4">
            ...
            <div className="rounded-2xl bg-secondary border border-border p-5">
              ...
              <div className="mt-5">
                <a
                  href="mailto:contact@larinova.com?subject=Enterprise%20Inquiry"
