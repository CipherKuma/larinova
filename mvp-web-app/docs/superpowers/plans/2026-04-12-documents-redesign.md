...
>
> **Testing flow**: No explicit test flow in CLAUDE.md for mvp-web-app. Use: implement → typecheck (`npx tsc --noEmit` in `mvp-web-app/`) → visual verification via Playwright MCP at `http://localhost:3000`.
>
...
**Project flow reference:** Read `mvp-web-app/CLAUDE.md` for project-specific conventions.
...
```bash
cd /Users/gabrielantonyxaviour/Documents/products/larinova/mvp-web-app && npx tsc --noEmit 2>&1 | head -30
```
...
```bash
cd /Users/gabrielantonyxaviour/Documents/products/larinova/mvp-web-app && npx tsc --noEmit 2>&1 | head -50
```
