...
**Spec:** `/Users/gabrielantonyxaviour/Documents/products/larinova/mvp-web-app/docs/superpowers/specs/2026-04-12-locale-split-india-indonesia-design.md` — authoritative for every architectural decision in this plan.
...
```bash
cd /Users/gabrielantonyxaviour/Documents/products/larinova/mvp-web-app
...
**Owns (Phase 1a):** `mvp-web-app/messages/id.json`, `landing/messages/id.json`. NO `.tsx` edits in Phase 1a — those come in Phase 1b.
...
### Task C2: Author Bahasa translations in `mvp-web-app/messages/id.json`
...
```bash
git add messages/id.json
git commit -m "feat(i18n): author Bahasa translations for mvp-web-app id.json"
```
...
```bash
cmux send --surface <lead-surface> "[TEAMMATE:content-author] Phase 1a complete. mvp-web-app id.json fully authored (N strings). landing id.json authored. Beta banner added. Waiting for Phase 1a teammates to finish before starting Phase 1b (.tsx string extraction)."
cmux send-key --surface <lead-surface> Enter
```
...
- [ ] **Step 1: Deploy mvp-web-app to staging**
