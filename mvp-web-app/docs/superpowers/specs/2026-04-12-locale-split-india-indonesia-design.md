...
**Scope:** `mvp-web-app` + `landing` (both Next.js apps under `~/Documents/products/larinova/`)
...
- `mvp-web-app/messages/in.json` — authored English (copied from current `en.json` as starting point, adjusted for Indian English)
- `mvp-web-app/messages/id.json` — authored Bahasa Indonesia (fresh, not machine-translated)
...
| `content-author` | `mvp-web-app/messages/id.json`, `landing/messages/id.json` |
...
2. Full build + type check for both `mvp-web-app` and `landing`
...
Read the full spec first:
  /Users/gabrielantonyxaviour/Documents/products/larinova/mvp-web-app/docs/superpowers/specs/2026-04-12-locale-split-india-indonesia-design.md
...
- `~/Documents/products/larinova/mvp-web-app/docs/superpowers/specs/2026-03-20-onboarding-redesign-design.md` — prior onboarding redesign spec (still relevant to Phase 1a content extraction)
