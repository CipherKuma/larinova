...
import { sendPrescriptionEmail } from "@/lib/resend/email";
...
export async function POST(
  ...
  try {
    ...
    // Send consultation summary email via unified notify()
    const summaryResult = await notify(
      "email",
      "consultation_summary",
      {
        ...
        consultationDate,
        plainSummary: consultation.summary || "",
